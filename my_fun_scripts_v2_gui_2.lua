...
local function GetClosestAimbotTarget()
	...
	for _, Player in ipairs(
		...
		if Player.Team then
			local SelectedTeams = AimbotSettings.TargetTeams
			if SelectedTeams ~= nil then
				if not SelectedTeams[Player.Team.Name] then
					continue
				end
			elseif AimbotSettings.TargetTeam ~= "All" then
				if Player.Team.Name ~= AimbotSettings.TargetTeam then
					continue
				end
			end
		else
