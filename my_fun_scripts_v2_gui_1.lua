...
AimbotPage.CanvasSize = UDim2.new(0, 0, 0, 560)
...
local TargetTeamButton = Instance.new("TextButton")
TargetTeamButton.Size = UDim2.new(1, -10, 0, 42)
TargetTeamButton.Position = UDim2.new(0, 0, 0, 195)
TargetTeamButton.BackgroundColor3 = Color3.fromRGB(32, 32, 32)
TargetTeamButton.BorderSizePixel = 0
TargetTeamButton.TextColor3 = Color3.fromRGB(220, 220, 220)
TargetTeamButton.TextSize = 13
TargetTeamButton.Font = Enum.Font.Gotham
TargetTeamButton.TextXAlignment = Enum.TextXAlignment.Left
TargetTeamButton.AutoButtonColor = false
TargetTeamButton.Text = "   Target Teams: ALL"
TargetTeamButton.Parent = AimbotPage

local TargetTeamArrow = Instance.new("TextLabel")
TargetTeamArrow.Size = UDim2.new(0, 30, 1, 0)
TargetTeamArrow.Position = UDim2.new(1, -35, 0, 0)
TargetTeamArrow.BackgroundTransparency = 1
TargetTeamArrow.Text = "▼"
TargetTeamArrow.TextColor3 = Color3.fromRGB(180, 180, 180)
TargetTeamArrow.TextSize = 14
TargetTeamArrow.Font = Enum.Font.GothamBold
TargetTeamArrow.Parent = TargetTeamButton

local TargetTeamCorner = Instance.new("UICorner")
TargetTeamCorner.CornerRadius = UDim.new(0, 6)
TargetTeamCorner.Parent = TargetTeamButton

local TargetTeamDropdown = Instance.new("ScrollingFrame")
TargetTeamDropdown.Size = UDim2.new(1, -10, 0, 0)
TargetTeamDropdown.Position = UDim2.new(0, 0, 0, 240)
TargetTeamDropdown.BackgroundColor3 = Color3.fromRGB(24, 24, 24)
TargetTeamDropdown.BorderSizePixel = 0
TargetTeamDropdown.ScrollBarThickness = 4
TargetTeamDropdown.ScrollBarImageColor3 = Color3.fromRGB(90, 90, 90)
TargetTeamDropdown.CanvasSize = UDim2.new(0, 0, 0, 0)
TargetTeamDropdown.Visible = false
TargetTeamDropdown.ZIndex = 20
TargetTeamDropdown.Parent = AimbotPage

local TargetTeamDropdownCorner = Instance.new("UICorner")
TargetTeamDropdownCorner.CornerRadius = UDim.new(0, 6)
TargetTeamDropdownCorner.Parent = TargetTeamDropdown

local TargetTeamList = Instance.new("UIListLayout")
TargetTeamList.Padding = UDim.new(0, 4)
TargetTeamList.SortOrder = Enum.SortOrder.LayoutOrder
TargetTeamList.Parent = TargetTeamDropdown

local TargetTeamPadding = Instance.new("UIPadding")
TargetTeamPadding.PaddingTop = UDim.new(0, 5)
TargetTeamPadding.PaddingBottom = UDim.new(0, 5)
TargetTeamPadding.PaddingLeft = UDim.new(0, 5)
TargetTeamPadding.PaddingRight = UDim.new(0, 5)
TargetTeamPadding.Parent = TargetTeamDropdown

local TargetTeamDropdownOpen = false

local function GetAimbotTeamNames()
	local Names = {"All"}
	local Seen = {All = true}
...
local function IsAimbotTeamSelected(Name)
	if Name == "All" then
		return AimbotSettings.TargetTeams == nil
	end
	if AimbotSettings.TargetTeams == nil then
		return true
	end
	return AimbotSettings.TargetTeams[Name] == true
end

local function AreAllAimbotTeamsSelected(Names)
	for _, Name in ipairs(Names) do
		if Name ~= "All" and not IsAimbotTeamSelected(Name) then
			return false
		end
	end
	return true
...
local function UpdateTargetTeamSummary()
	local Names = GetAimbotTeamNames()
	local Selected = {}

	for _, Name in ipairs(Names) do
		if Name ~= "All" and IsAimbotTeamSelected(Name) then
			table.insert(Selected, Name)
		end
	end

	if AimbotSettings.TargetTeams == nil or #Selected == #Names - 1 then
		TargetTeamButton.Text = "   Target Teams: ALL"
	elseif #Selected == 0 then
		TargetTeamButton.Text = "   Target Teams: NONE"
	elseif #Selected == 1 then
		TargetTeamButton.Text = "   Target Teams: " .. string.upper(Selected[1])
	else
		TargetTeamButton.Text = "   Target Teams: " .. #Selected .. " SELECTED"
	end

	TargetTeamArrow.Text = TargetTeamDropdownOpen and "▲" or "▼"
end

local function UpdateAimbotTeamButtons()
	for _, Child in ipairs(TargetTeamDropdown:GetChildren()) do
		if Child:IsA("TextButton") then
			local Name = Child:GetAttribute("TeamName")
			if Name then
				local Selected = IsAimbotTeamSelected(Name)
				Child.BackgroundColor3 = Selected
					and Color3.fromRGB(55, 125, 65)
					or Color3.fromRGB(38, 38, 38)
				Child.TextColor3 = Selected
					and Color3.fromRGB(235, 255, 235)
					or Color3.fromRGB(220, 220, 220)
			end
		end
	end
	UpdateTargetTeamSummary()
end

local function RebuildAimbotTeamDropdown()
	for _, Child in ipairs(TargetTeamDropdown:GetChildren()) do
		if Child:IsA("TextButton") then
			Child:Destroy()
		end
	...
	for Index, Name in ipairs(Names) do
		...
		Button.Name = "Team_" .. tostring(Index)
		...
		Button.ZIndex = 21
		Button:SetAttribute("TeamName", Name)
		Button.Parent = TargetTeamDropdown
		...
		Button.MouseButton1Click:Connect(function()
			if Name == "All" then
				local SelectAll = not AreAllAimbotTeamsSelected(Names)
				AimbotSettings.TargetTeams = {}
				for _, TeamName in ipairs(Names) do
					if TeamName ~= "All" then
						AimbotSettings.TargetTeams[TeamName] = SelectAll
					end
				end
			else
				if AimbotSettings.TargetTeams == nil then
					...
					for _, TeamName in ipairs(Names) do
						if TeamName ~= "All" then
							AimbotSettings.TargetTeams[TeamName] = true
						end
					end
				end
				AimbotSettings.TargetTeams[Name] = not IsAimbotTeamSelected(Name)
			end
	...
	local Count = #Names
	local ContentHeight = Count * 34 + math.max(0, Count - 1) * 4 + 10
	TargetTeamDropdown.CanvasSize = UDim2.new(0, 0, 0, ContentHeight)
	TargetTeamDropdown.Size = UDim2.new(1, -10, 0, math.min(ContentHeight, 190))
	TargetTeamDropdown.Visible = TargetTeamDropdownOpen
	UpdateAimbotTeamButtons()
end

TargetTeamButton.MouseButton1Click:Connect(function()
	TargetTeamDropdownOpen = not TargetTeamDropdownOpen
	RebuildAimbotTeamDropdown()
end)
...
FOVButton.Position = UDim2.new(0, 0, 0, 245)
...
AimKeyButton.Position = UDim2.new(0, 0, 0, 295)
...
VisibilityButton.Position = UDim2.new(0, 0, 0, 345)
